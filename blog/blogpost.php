...
<head>
  <meta charset="utf-8">
  <title>SDL SMARTLABS | BLOG</title>
  ...
  <header id="header">
    <div class="container-fluid">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="https://sdlsmartlabs.co.in/#intro" class="scrollto">SDL SMARTLABS</a></h1>
        <a href="https://sdlsmartlabs.co.in/#intro"><img src=".././img/logo.png" alt="" title="" /></a>
      </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Useful Links</h4>
            <ul>
              <li><i class="ion-ios-arrow-right"></i> <a href="https://sdlsmartlabs.co.in">Home</a></li>
              <li><i class="ion-ios-arrow-right"></i> <a href="https://sdlsmartlabs.co.in/#about">About us</a></li>
              <li><i class="ion-ios-arrow-right"></i> <a href="https://sdlsmartlabs.co.in/#services">Services</a></li>
